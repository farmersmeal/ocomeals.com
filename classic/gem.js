(function(jQuery) {
    try {
        var $module = jQuery('#m-1617297312207').children('.module');
...
(function(jQuery) {
    try {
        var $module = jQuery('#m-1617300716550').children('.module');
        var single = $module.attr('data-single');
        var openDefault = $module.attr('data-openDefault');
        var openTab = $module.attr('data-openTab');
        var mode = jQuery('.gryffeditor').hasClass('editing') ? 'dev' : 'production';
...
(function(jQuery) {
    var $hero = jQuery('#m-1617299943494');
    var $module = jQuery('#m-1617299943494').children('.module');
...
(function(jQuery) {
    var $hero = jQuery('#m-1617299943420');
    var $module = jQuery('#m-1617299943420').children('.module');
...
(function(jQuery) {
    var $hero = jQuery('#m-1617299943457');
    var $module = jQuery('#m-1617299943457').children('.module');
